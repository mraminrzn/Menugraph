...
const Footer = () => {
    return (
        <div className=' relative bottom-0 max-w-full'>
        <footer className='  bottom-0 flex backdrop-blur-lg	 justify-around text-center items-center mt-20 w-full h-40 bg-[#34343c]' >
            <div className=' leading-7'>
                ...
                {/* <Link className=' mr-3 text-right list-none blcok text-slate-400' href={'/allrestaurants'}>لیست رستوران ها</Link> */}
            </div>
            <div className=' leading-7'>
